...
else if (taille >= 166 && taille < 178 && poids >= 48 && poids <= 53 ||
        taille >= 163 && taille < 175 && poids >= 54 && poids <= 59 ||
        taille >= 160 && taille < 172 && poids >= 60 && poids <= 65 ||
        taille >= 157 && taille < 169 && poids >= 66 && poids <= 71)
{
